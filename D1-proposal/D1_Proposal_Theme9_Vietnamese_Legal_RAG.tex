...
\begin{enumerate}
  ...
  \item \textbf{Claim Auditor Agent (Adversarial Critic):} Bounded by zero-hallucination guardrails. Deconstructs candidate drafts into atomic propositions and cross-verifies each 1-to-1 against authoritative source statutes before release.
\end{enumerate}
