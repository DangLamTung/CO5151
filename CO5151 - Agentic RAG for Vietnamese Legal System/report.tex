...
\title{AGENTIC RAG FOR LEGAL SYSTEM}
...
% \input{content/01_overview}

\newgeometry{left=2.1cm,right=2.1cm,top=2.0cm,bottom=2.0cm,includeheadfoot,headheight=14pt,headsep=12pt,footskip=18pt}
\begingroup
\setstretch{1.15}
\fontsize{10pt}{13.5pt}\selectfont
\renewcommand{\small}{\fontsize{9pt}{11.5pt}\selectfont}
\titleformat{\section}{\normalfont\fontsize{11.5pt}{14pt}\selectfont\bfseries}{\thesection}{0.6em}{}
\titleformat{\subsection}{\normalfont\fontsize{10.5pt}{13pt}\selectfont\bfseries}{\thesubsection}{0.5em}{}
\titlespacing*{\section}{0pt}{9pt}{4.5pt}
\titlespacing*{\subsection}{0pt}{7pt}{3.5pt}
\setlength{\parindent}{0pt}
\setlength{\parskip}{4pt}
\setlist{nosep,leftmargin=16pt,itemsep=2.5pt,topsep=2pt}
